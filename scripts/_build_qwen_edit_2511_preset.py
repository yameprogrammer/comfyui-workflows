...
API_NAME = "qwen_edit_2511"
PRESET_KEY = "qwen_edit_2511"

# Agent: LoaderGGUF (not ~20GB fp8 UNETLoader)
GGUF = r"QwenImage\qwen-image-edit-2511-Q4_K_M.gguf"
LORA_LIGHTNING = (
...
def build_ports() -> dict:
    return {
        ...
        "notes": [
            "Agent: LoaderGGUF (Q4_K_M) instead of fp8 UNETLoader",
            "Active path: subgraph Image Edit (Qwen 2511); Raw Latent branch omitted",
...
def patch_catalog_and_features() -> None:
    ...
    cat["workflows"]["qwen_edit_2511"] = entry
    cat_path.write_text(
    ...
    fp.setdefault("presets", {})[PRESET_KEY] = {
        "feature_ids": ["qwen_edit", "qwen_edit_2511"],
        "file": f"presets/{API_NAME}.api.json",
        "ports": f"presets/{API_NAME}.ports.json",
        "family": "qwen_edit",
        "status": "ready",
