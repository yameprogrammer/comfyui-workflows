...
* **구현 착수 스펙 (코딩 시 필수)**: [character_impl_spec.md](character_impl_spec.md)
* **프리셋·템플릿**: [characters/](characters/)
* **활성 트랙**: L2 Soft Factory → 다음 코딩은 P1(`generate_moody*.py` seed/meta) → P2(create/expand/approve)
