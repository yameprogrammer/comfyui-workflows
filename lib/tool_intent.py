...
INTENT_TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "summary": "영상 클립 품질 계획·프롬프트 검사·후처리 폴리시",
        "when": "I2V/S2V 전 품질 티어 선택, 모션 프롬프트 방언 검사, face/upscale 체인",
        ...
        "alternatives": [
            {"if": "생성 실행", "use": "i2v_generic", "cli": "python scripts/generate_i2v.py -i key.png -p \"...\" -o clip.mp4"},
