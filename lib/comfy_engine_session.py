...
FAMILY_HY3D = "hy3d"  # Hunyuan3D / Kijai Hy3D mesh — KR Community License blocked; not agent default
FAMILY_TRELLIS2 = "trellis2"  # Microsoft TRELLIS 2 (MIT weights). Agent MESH default.
FAMILY_ACE = "ace_step"  # BGM
FAMILY_QWEN_EDIT = "qwen_edit_2509"  # Qwen-Image-Edit 2509/2511 instruction edit
FAMILY_QWEN_IMAGE_21 = "qwen_image_21"  # Qwen-Image 2.1 GGUF + qwen3vl (separate VRAM stack)
